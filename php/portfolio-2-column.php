	...
	<div id="main">
		<div class="width-container">
				...
				<div class="content-boxed">
					<h2 class="title-bg">Portfolio 2 Column</h2>
					
					
					<ul id="child-pages">
						<li><a href="#" class="button secondary-button">Web Design</a></li>
						<li><a href="#" class="button secondary-button">Photography</a></li>
						<li><a href="#" class="button secondary-button">Logos</a></li>
					</ul>
					<div class="clearfix"></div>
					...
					<div class="grid2column">
						<div class="portfolio-image">
							<a href="images/demo/portfolio-thumb.jpg" rel="prettyphoto[gallery]"><img src="images/demo/portfolio-thumb.jpg" alt=""></a>
						</div>
						<h3><a href="portfolio-single.php">Portfolio Item Title</a></h3>
						<P>Aliquam placerat blandit neque sit amet congue. Etiam sit amet aliquam nisl. Nulla venenatis tempus ligula vel laoreet. Sed vulputate mattis pharetra...</P>
						<hr>
					</div>
