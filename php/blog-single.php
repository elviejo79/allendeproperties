		...
		<div class="width-container">
			...
			<div id="container-sidebar">
				<div class="content-boxed">
					...
					<div class="type-post">
						<h3>Suspendisse adipiscing augue congue magna pulvinar</h3>
						<div class="post-data">Posted on <a href="#">Jun 29, 2012</a> by <a href="#">Admin</a> in <a href="#">Real Estate</a>, <a href="#">Blog</a></div>
						<div class="featured-image">
							<a href="images/demo/blog-image.jpg" rel="PrettyPhoto"><img src="images/demo/blog-image.jpg" alt=""></a>
						</div>
						...
						<p>Pellentesque vitae felis eu mi suscipit luctus a ullamcorper eros. Quisque lectus enim, hendrerit euismod adipiscing vitae, ultrices at ligula. Pellentesque sit amet lacus sapien, ac convallis odio. Pellentesque mattis, nunc nec varius posuere, tortor quam sodales lectus, a ultricies dui lorem eget justo. Sed id purus nisi. Nulla ligula lacus, volutpat sed consectetur nec, molestie nec magna. Vestibulum porttitor dapibus risus, eget bibendum sem sodales non.</p>
						
						<p>Aliquam tristique varius lacus, nec pharetra felis dictum sit amet. Phasellus semper eleifend mi in malesuada. Aliquam placerat blandit neque sit amet congue. Etiam sit amet aliquam nisl. Nulla venenatis tempus ligula vel laoreet. Sed vulputate mattis pharetra. In tempus felis id leo fringilla pharetra. Maecenas in felis a sapien laoreet imperdiet. Sed ipsum felis, scelerisque eget gravida lacinia, posuere in est. Quisque ac blandit elit. </p>
					...
					<div class="share-section">
						<div class="tags">Tags: <a href="#">Houses</a>, <a href="#">Real Estate</a>, <a href="#">Family</a>, <a href="#">News</a>, <a href="#">Latest</a></div>
				...
				<div class="content-boxed">
					<h2 class="title-bg">Comments</h2>
					
					
					<ol class="commentlist">
									<li class="comment byuser comment-author-progressionstudios bypostauthor even thread-even depth-1" id="li-comment-9">
							<article id="comment-9" class="comment">
								<div class="comment-meta">
									<div class="comment-author vcard">
										<img alt='' src='http://1.gravatar.com/avatar/ba52f9c3e9ebf4d37ffe96fc163ceaa4?s=68&amp;d=http%3A%2F%2F1.gravatar.com%2Favatar%2Fad516503a11cd5ca435acc9bb6523536%3Fs%3D68&amp;r=G' class='avatar avatar-68 photo' height='68' width='68' /><span class="fn">Mike</span> on <a href="#"><time pubdate datetime="2012-07-10T05:07:40+00:00">July 10, 2012 at 5:07 am</time></a> <span class="says">said:</span>
					...
					To delete a comment, just log in and view the post&#8217;s comments. There you will have the option to edit or delete them.</p>
						...
						<ul class='children'>
						<li class="comment byuser comment-author-progressionstudios bypostauthor odd alt depth-2" id="li-comment-10">
							<article id="comment-10" class="comment">
								<div class="comment-meta">
									<div class="comment-author vcard">
										<img alt='' src='http://1.gravatar.com/avatar/ba52f9c3e9ebf4d37ffe96fc163ceaa4?s=39&amp;d=http%3A%2F%2F1.gravatar.com%2Favatar%2Fad516503a11cd5ca435acc9bb6523536%3Fs%3D39&amp;r=G' class='avatar avatar-39 photo' height='39' width='39' /><span class="fn">Mike</span> on <a href="#"><time pubdate datetime="2012-07-10T05:07:48+00:00">July 10, 2012 at 5:07 am</time></a> <span class="says">said:</span>
														</div><!-- .comment-author .vcard -->


								</div>

								<div class="comment-content"><p>Sample reply to a comment&#8230;</p>
					</div>
					...
					<h2 class="grey-header-bar">Leave a reply</h2>
					
					<div id="reply">
						<div><input type="text" id="textname" size="22" placeholder="Name*"/></div>

						<div><input type="text" id="textemail" size="22" placeholder="Email*" /></div>
						
						<div><input type="text" id="textwebsite" size="22" placeholder="Website" /></div>


						<div><textarea id="comment" cols="50"  rows="10" placeholder="Enter Comment"></textarea></div>
						
						<div><input type="submit" value="Post Comment" name="submit" class="submit" /></div>
					</div>
